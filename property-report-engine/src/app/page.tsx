  ...
  return (
    <main>
      <header className="app-header no-print">
        <a className="brand" href="#"><span className="brand-mark">A</span><span>Artemis Mortgage<small>Property Report Engine</small></span></a>
...
function Report({ property, form, mortgage, reportCard, onEdit }: { property: NormalizedProperty; form: FormState; mortgage: ReturnType<typeof calculateMortgage>; reportCard: ReturnType<typeof scoreReportCard>; onEdit: () => void }) {
  ...
  return <div className="report-shell">
    ...
    <article className="report">
      ...
      <footer className="disclosure"><strong>Important disclosure</strong><p>This proprietary report card is for educational and marketing purposes only. It is not an appraisal, property inspection, underwriting decision, loan approval, or guarantee of property value, rent, appreciation, investment return, interest rate, payment, or closing costs. Figures labeled as estimates or projections may change. Verify property, market, loan-program, and cost information with appropriate licensed professionals before making a decision.</p><div><span>Austin Bacon · Loan Officer</span><span>Artemis Mortgage · Arizona</span><span>For compliance review before publication</span></div></footer>
    </article>
  </div>;
}
