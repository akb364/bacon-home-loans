    ...
    <main>
      <header className="app-header no-print">
        ...
        <div className="header-actions">
          <span className="status-dot"><i /> Manual data mode</span>
      ...
      {view === "intake" ? (
        <div className="workspace">
          <aside className="rail">
            ...
            <p>Enter only what you know. Missing information stays clearly marked unavailable and is excluded from scoring.</p>
            <ol><li className="active"><b>1</b>Property</li><li><b>2</b>Financing</li><li><b>3</b>Review & generate</li></ol>
            <div className="rail-note"><strong>Designed for compliance</strong><span>Every value retains its source and classification.</span></div>
          </aside>
          <section className="intake">
            ...
            <FormSection number="01" title="Property location" description="This becomes the report title and future provider lookup key.">
            ...
            <FormSection number="02" title="Property facts" description="Use verified records when available; blanks remain unavailable.">
              ...
              <MoneyField label="Estimated market value" field="estimatedValue" value={form.estimatedValue} change={change} hint="Third-party estimate when integrated" />
